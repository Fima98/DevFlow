...
const hotQuestions = [
  ...
  { _id: "3", title: "How to handle form validation in React?" },
  { _id: "4", title: "What is the purpose of useEffect in React?" },
  { _id: "5", title: "How to use React Router for client-side navigation?" },
];
